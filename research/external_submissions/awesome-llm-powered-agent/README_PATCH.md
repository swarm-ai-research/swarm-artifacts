# Awesome LLM-Powered Agent — SWARM Submission

**Target repo:** [hyp1231/awesome-llm-powered-agent](https://github.com/hyp1231/awesome-llm-powered-agent)
**Target section:** `### Multi-Agent Simulation Projects` (under `## Open-Source Projects`)

## Entry to add

Append the following line at the end of the **Multi-Agent Simulation Projects** section
